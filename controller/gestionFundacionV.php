<?php
	...
	$TITULO_DESBLOQUEAR="Desbloquear Fundacion";
	$TITULO_AGREGAR="Registrar Fundacion";
	$TITULO_ELIMINAR="Bloquear Fundacion";
	$TITULO_EDITAR="Editar Fundacion";
	$TITULO_CONSULTAR="Consultar Fundacion";
