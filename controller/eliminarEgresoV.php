...
$ACTION="eliminarEgreso.php";
$TITULO="Bloquear Egreso";
...
$query = "Select e.*, p.nombre as nombPer, p.apellido as apePer, t.nombre as nomTip from Egreso e, Persona p, Tipo t WHERE e.status <> -1 AND e.fkPersona = p.idPersona AND e.tipo = t.idTipo  ORDER BY nombre ASC";
