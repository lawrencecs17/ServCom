<?php
	...
	$TITULO_DESBLOQUEAR="Desbloquear Cheque";
	$TITULO_AGREGAR="Registrar Cheque";
	$TITULO_ELIMINAR="Bloquear Cheque";
	$TITULO_EDITAR="Editar Cheque";
	$TITULO_CONSULTAR="Consultar Cheque";
